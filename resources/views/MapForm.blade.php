...
<body>
    <div class="all-padding">
        ...
        {!! Form::open() !!}
            ...
            {!! Form::text('location', '', ['class' => 'form-control', 'id'=>'location']) !!} <br />
    ...
    {!! Html::script('https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyCnB9CM1raIla-HdXTM_8fwnLtN2rY65Ig') !!}
